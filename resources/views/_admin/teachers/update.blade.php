...
@section('content')
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div
            ...
            <form navigate-form action="{{ route('admin.teachers.do_update', $data->id) }}" method="POST" class="p-6">
                @csrf
                <div class="space-y-4">
                    <!-- Form Group -->
                    <div>
                        <label for="name" class="block text-sm font-medium mb-2 dark:text-white">Nama Guru <span
