        ...
        <div class="bg-white border border-gray-200 rounded-lg shadow-sm p-5 dark:bg-neutral-800 dark:border-neutral-700">
            <div class="flex items-center gap-x-3">
                ...
                <div>
                    ...
                    <h3 class="text-xl font-bold text-gray-800 dark:text-neutral-200">{{ $scores ? $scores->total() : 0 }}</h3>
                </div>
            </div>
        </div>
            ...
            <div class="flex items-center gap-x-3">
                ...
                <div>
                    ...
                    <h3 class="text-xl font-bold text-gray-800 dark:text-neutral-200">
                        {{ $scores && $scores->count() > 0 ? number_format($scores->avg('score'), 1) : '0' }}
                    </h3>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white border border-gray-200 rounded-lg shadow-sm p-5 dark:bg-neutral-800 dark:border-neutral-700">
            <div class="flex items-center gap-x-3">
                ...
                <div>
                    ...
                    <h3 class="text-xl font-bold text-gray-800 dark:text-neutral-200">
                        {{ $scores && $scores->count() > 0 ? $scores->max('score') : '0' }}
                    </h3>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white border border-gray-200 rounded-lg shadow-sm p-5 dark:bg-neutral-800 dark:border-neutral-700">
            <div class="flex items-center gap-x-3">
                ...
                <div>
                    ...
                    <h3 class="text-xl font-bold text-gray-800 dark:text-neutral-200">
                        {{ $scores && $scores->count() > 0 ? $scores->min('score') : '0' }}
                    </h3>
                </div>
            </div>
        </div>
