...
{
    protected string $name = 'image_generation_agent';
     ...
     * 3. File: resources/prompts/image_generation_agent/default.blade.php
     * 4. Fallback: This property
     * 
     * The prompt file has been created for you at:
     * resources/prompts/image_generation_agent/default.blade.php
     */
    protected string $instructions = 'You are Image Generation Agent. See resources/prompts/image_generation_agent/default.blade.php for full instructions.';
